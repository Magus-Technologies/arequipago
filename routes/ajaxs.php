...
Route::get('/ajs/beneficios/listar/:idUsuario/:tipo', 'BeneficioController@listarBeneficios');  // Obtener beneficios filtrados por departamento del usuario
...
Route::get('/ajs/obtenerResumenDescuentos', 'ProductosController@obtenerResumenDescuentos');
Route::get('/ajs/obtenerProductosConDescuento', 'ProductosController@obtenerProductosConDescuento');
Route::post('/ajs/aplicarDescuentoMasivo', 'ProductosController@aplicarDescuentoMasivo');
Route::post('/ajs/actualizarDescuentoProducto', 'ProductosController@actualizarDescuentoProducto');
