...
class __TwigTemplate_cb3bd92bfb278bff3b5f7a35ccf18028a24dd0f9fe90554db7ca3de20cd1cc85 extends Template
{
    private $source;
    private $macros = [];
...
<head>
    ...
    <style type=\"text/css\">
        ";
        // line 5
        $this->loadTemplate("assets/style.css", "perception.html.twig", 5)->display($context);
        // line 6
        echo "    </style>
</head>
<body class=\"white-bg\">
";
        ...
        // line 10
        $context["name"] = $this->env->getRuntime('Greenter\Report\Filter\DocumentFilter')->getValueCatalog("40", "01");
        // line 11
    ...
    <tbody><tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["det"]) {
            ...
            echo "</td>
                            <td align=\"center\">";
            // line 115
            echo twig_escape_filter($this->env, $this->env->getRuntime('Greenter\Report\Filter\FormatFilter')->number(twig_get_attribute($this->env, $this->source, $context["det"], "impPercibido", [], "any", false, false, false, 115)), "html", null, true);
            echo "</td>
                            <td align=\"center\">";
            // line 116
            echo twig_escape_filter($this->env, $this->env->getRuntime('Greenter\Report\Filter\FormatFilter')->number(twig_get_attribute($this->env, $this->source, $context["det"], "impCobrar", [], "any", false, false, false, 116)), "html", null, true);
            echo "</td>
                        </tr>
                        ";
        }
        ...
        echo "  ";
        echo twig_escape_filter($this->env, $this->env->getRuntime('Greenter\Report\Filter\FormatFilter')->number(twig_get_attribute($this->env, $this->source, (isset($context["doc"]) || array_key_exists("doc", $context) ? $context["doc"] : (function () { throw new RuntimeError('Variable "doc" does not exist.', 145, $this->source); })()), "impPercibido", [], "any", false, false, false, 145)), "html", null, true);
        echo "</span></td>
                            </tr>
                            <tr class=\"border_bottom\">
        ...
        echo "  ";
        echo twig_escape_filter($this->env, $this->env->getRuntime('Greenter\Report\Filter\FormatFilter')->number(twig_get_attribute($this->env, $this->source, (isset($context["doc"]) || array_key_exists("doc", $context) ? $context["doc"] : (function () { throw new RuntimeError('Variable "doc" does not exist.', 149, $this->source); })()), "impCobrado", [], "any", false, false, false, 149)), "html", null, true);
        echo "</span></td>
                            </tr>
                            </tbody>
                        </table>
    ...
    {
        return new Source("", "perception.html.twig", "/var/www/html/sunat/vendor/greenter/report/src/Report/Templates/perception.html.twig");
    }
}
