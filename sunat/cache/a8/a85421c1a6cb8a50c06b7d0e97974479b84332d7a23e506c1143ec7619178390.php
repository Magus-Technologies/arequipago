...
/* summary.xml.twig */
class __TwigTemplate_33ae2bc2e2caa2945438d23b72648187baf483b38f24839c8d36e0c373dba9df extends Template
{
    private $source;
    private $macros = [];
...
";
        $___internal_806a818be12deb87bf8415ae921faf99208370f628f0195cee636402934d4b77_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 1
        echo twig_spaceless($___internal_806a818be12deb87bf8415ae921faf99208370f628f0195cee636402934d4b77_);
    }
    ...
    {
        return new Source("", "summary.xml.twig", "/var/www/html/sunat/vendor/greenter/xml/src/Xml/Templates/summary.xml.twig");
    }
}
