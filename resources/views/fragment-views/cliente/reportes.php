...
<head>
    ...
    <style>
        ...
        .report-card.selected {
            border-color: #02a499;
            background-color: rgba(2, 164, 153, 0.05);
        }
        ...
        /* Todos los tiempos checkbox styling */
        #todos_los_tiempos:checked + label {
            color: #02a499;
            font-weight: 600;
        }
        
        #todos_los_tiempos:checked + label .fa-infinity {
        ...
        #prev-btn:hover {
            background-color: #7e7e7e; /* Un tono un poco más oscuro al pasar el mouse */
            border-color: #7e7e7e;
        }
...
function renderVentasPorCategoriaTable(data) {
    ...
    Object.keys(categorias).forEach(function(categoria) {
        ...
        html += `
            <tr class="table-info">
                <td colspan="5"><strong>Subtotal ${categoria}</strong></td>
