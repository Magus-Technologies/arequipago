                                            ...
                                            <table class="table" style="width: 100%; ">
                                                ...
                                                <tbody>
                                                    <tr v-for="(item,index) in productos">
                                                        ...
                                                        <td><span v-if="!item.editable">{{item.cantidad}}</span><input v-if="item.editable" v-model="item.cantidad"></td>
                                                        <td><span v-if="!item.editable">{{item.precioVenta}}</span><input v-if="item.editable" v-model="item.precioVenta"></td>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button id="btnCerrarModal" type="button" class="btn btn-danger" >Cerrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="modalSelMultiProd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered  modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                <button type="button" class="btn btn-danger" id="btn-cerrar-modal-2">Cerrar</button>
                                </div>
                            </div>
                        </div>
                    </div>
