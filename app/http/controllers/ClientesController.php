    ...
    /*   public function importAdd(){
        ...
        public function guardarCliente()
        {
            ...
            if ($clienteModel->documentoExistente($_POST['n_documento'])) {
                echo json_encode(['success' => false, 'message' => 'El n�mero de documento ya est� registrado']);
                return;
            }
            ...
            foreach ($archivos as $archivo) {
                if (isset($_FILES[$archivo]) && $_FILES[$archivo]['error'] === UPLOAD_ERR_OK) {
                    ...
                    // Si no se subi� archivo o hubo error, asignar vac�o
            ...
            if ($resultado && $resultado !== false) {
                echo json_encode([
                    ...
                    'cliente_id' => $resultado // Ahora $resultado contiene el ID
                ]);
            } else {
        ...
        /**
         * Método para consultar datos de un cliente por número de documento
         * 
        ...
        public function editarCliente() {
            ...
            if ($clienteActual['n_documento'] != $_POST['n_documento'] && $clienteModel->documentoExistente($_POST['n_documento'])) {
                echo json_encode(['success' => false, 'mensaje' => 'El número de documento ya existe en la base de datos']);
                return;
            }
        ...
        public function guardarPago()
        {
            ...
            // Validar campos requeridos
            $camposRequeridos = ['cliente_id', 'metodo_pago_id', 'monto_pagado'];
            ...
            $montoTotal = 100.00;
            $metodoPagoId = intval($_POST['metodo_pago_id']);
            
            // Validaciones según el método de pago
            if ($metodoPagoId == 12) { // Efectivo
                if ($montoPagado < $montoTotal) {
                    echo json_encode(['success' => false, 'message' => 'El monto pagado debe ser mayor o igual a S/ 100.00']);
                    return;
                }
                ...
                if ($montoPagado != $montoTotal) {
                    echo json_encode(['success' => false, 'message' => 'Para este método de pago, el monto debe ser exactamente S/ 100.00']);
                    return;
                }
                $vuelto = 0.00;
            }
