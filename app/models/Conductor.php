...
class Conductor
{
    ...
    public function setCategoriaLicencia($categoria_licencia)
    {
    ...
    public function getNumeroCodFi()
    {
        return $this->numeroCodFi;
    }

    public function setNumeroCodFi($numeroCodFi)
    {
        $this->numeroCodFi = $numeroCodFi;
    }
