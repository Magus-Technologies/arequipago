...
private function normalizeString($string) {
    ...
    public function obtenerTotalClientesBusqueda($searchTerm = '') {
        try {
            ...
            $stmtConductores->bind_param("ssss", $searchTermLike, $searchTermLike, $searchTermLike, $searchTermLike);
            ...
            // CAMBIO: Añadido GROUP BY y HAVING para contar solo clientes con financiamientos
