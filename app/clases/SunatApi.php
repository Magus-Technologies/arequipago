...
//            var_dump($res);
            ...
            $see = $util->getSee2($endpoint);
            // Configurar algoritmos compatibles con OpenSSL 3.x antes del firmado


// Solución agresiva para OpenSSL 3.x - Desactivar completamente la verificación
putenv('OPENSSL_CONF=');
ini_set('openssl.cafile', '');
ini_set('openssl.capath', '');

// Configurar OpenSSL para permitir algoritmos inseguros
...
// Forzar variables de entorno para algoritmos legacy
putenv('OPENSSL_ENABLE_SHA1_SIGNATURES=1');
putenv('OPENSSL_ENABLE_MD5_VERIFY=1');
